const ServiceData = [
  {
    ...
    span: "$99/month",
    benefits: [
      "Customize your wellness experience with 2 services of your choice",
      "Enjoy the convenience of a fixed monthly fee for premium services",
      "Personalized focus on your top wellness priorities",
      "Flexible commitment without long-term contracts",
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "Monthly plan with bi-weekly check-ins - ",
    span: "$89",
    benefits: [
  ...
  },
  {
    ...
    description: "Monthly plan with weekly challenges - ",
    span: "$49",
    benefits: [
      "Personalized self-care challenges.",
      "Customized activities for body, mind, and soul.",
      "Elevate your routine with a monthly plan.",
      "Achieve optimal results with tailored practices.",
    ],
  },
];
